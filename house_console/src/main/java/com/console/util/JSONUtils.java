...
public class JSONUtils {
	...
	public static <T> T jsonToMap(String json) {
		return (T) jsonToObject(json, Map.class);
	}
	...
	public static <T> T jsonToObject(String json, Class<T> clasz) {
		...
		Object obj;
		try {
			obj = mapper.readValue(json, clasz);
	...
	public static String objectToJSON(Object object) {
		ObjectMapper mapper = new ObjectMapper();
		mapper
				.disable(new DeserializationConfig.Feature[] { DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES });
		mapper
	...
	public static String object2json(Object obj) {
		...
		if (obj == null) {
			...
			json.append("\"").append(
					string2json(obj.toString().replace(".0", ""))).append("\"");
		} else {
