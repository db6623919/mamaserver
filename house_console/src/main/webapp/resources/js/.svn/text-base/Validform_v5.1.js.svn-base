...
(function($,win,undef){
	...
	Validform.util={
		dataType:{
			...
			"n16":/^\d{16}$/,
			"s":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/,
			"s1-100":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{1,100}$/,
			"s6-18":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{6,18}$/,
			"s4":/^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{4}$/,
			"c6-20":/^[A-Za-z0-9]{6,20}$/,
			"p":/^[0-9]{6}$/,
			"pwd6-20":/^[a-z0-9_-]{6,20}$/,
			"m":/^13[0-9]{9}$|15[0-9]{9}$|18[0-9]{9}$/,
			"e":/^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
			"url":/^(\w+:\/\/)?\w+(\.\w+)+.*$/,
			"currency":/^\d+(\.\d+)?$/,
			"miugoMoney":/^(([1-9]{1}\d*)|0)(\.\d{1,2})?$/,
			"english":/^\d+(\.\d+)?$/,
			"chinese":/^[\u0391-\uFFE5]+$/,
			...
			"name":/^[a-zA-Z]{1}([a-zA-Z0-9]|[_]){1,19}$/,
