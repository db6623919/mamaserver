					...
					<div class="tab-content default-tab">
						<form id="mainForm" action="" method="post">
							...
							<p>
									...
									<input type="text" id="devName" name="devName" class="text-input small-input" style="width: 100px" width="60px"  />								
									</p>
								<p>
								...
								<p>
								 ...
								 <p>
									...
									<input type="text" value="" id="devImg" name="devImg" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
								 <p>
			...
			.Validform(
					{
						...
						beforeSubmit : function(curform) {
								$("#mainForm").attr("action","${pageContext.request.contextPath}/dev/addDeveloper.shtml");
