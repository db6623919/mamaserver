				...
				<div class="content-box-content">
					<div class="tab-content default-tab">
						<form id="mainForm" action="" method="post" enctype="multipart/form-data">
							<fieldset>
							<input type="hidden" name="count" id="count" value="${fn:length(renwoxing)}"/>
							<p>
								...
								<p>
									<span class="public_title"></span>
								     	<select id="allsort" name="allsort" multiple="true" style="height:300px">
								     		<c:forEach items="${renwoxing}" var="num" varStatus="status">
			...
			.Validform(
					{
						...
						beforeSubmit : function(curform) {
							...
							$("#mainForm").attr("action","${pageContext.request.contextPath}/indexManager/changeManager.shtml?type=renwoxing");
