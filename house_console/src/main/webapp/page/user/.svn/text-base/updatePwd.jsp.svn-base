			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab">
						...
						<form id="mainForm" action="${pageContext.request.contextPath }/user/changePwd.shtml" method="post">
							<fieldset>
								<p>
									<span class="public_title">原始密码：</span>
									<input type="password" id="oldPwd" name="oldPwd" tabindex="1" class="text-input small-input" datatype="*" nullmsg="请输入原始密码" errormsg="密码至少6个字符，最多20个字符，由字母或数字组成" /><span class="Validform_checktip">请输入原始密码</span>
								</p>
								<p>
