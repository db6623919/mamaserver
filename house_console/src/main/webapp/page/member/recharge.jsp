				...
				<div class="content-box-content">
					<div class="tab-content default-tab">
						<form id="mainForm" action="" method="post">
							...
							${result }
							<fieldset>
							    <input type="hidden" name="rewardFlowFlag" id="rewardFlowFlag" value="${rewardFlowFlag }"/>
								<p>
								...
								<p>
									<span class="public_title"><font color="red">*</font>&nbsp;累计充值金额<a>(?)</a>：</span>
									<input type="text" name="sumRechargeFlow" readonly="readonly" id="sumRechargeFlow" value="${sumRechargeFlow }"/>
								</p>
								<p>
									<span class="public_title"><font color="red">*</font>&nbsp;累计奖励金额<a>(?)</a>：</span>
									<input type="text" name="sumRewardFlow" readonly="readonly" id="sumRewardFlow" value="${sumRewardFlow }"/>
								</p>
								
								<p>
									<span class="public_title">充值金额：</span>
									<input type="text" value="" name="rechargeamt" id="rechargeamt" class="text-input small-input" nullmsg="请输入充值金额！" />
									<input type="button"  value="计算奖励" onclick="calculation()">
									<span class="Validform_checktip"></span>
								</p>
								<p>
									<span class="public_title">奖励金额：</span>
									<input type="text" readonly="readonly" name="rewardamt" id="rewardamt" class="text-input small-input" nullmsg="奖励金额！" /><span class="Validform_checktip"></span>
								</p>
								<p>
...
function calculation(){
	...
	var rewardFlowFlag=$('#rewardFlowFlag').val();
	var sumRechargeFlow=$('#sumRechargeFlow').val();
	var sumRewardFlow=$('#sumRewardFlow').val();
	var firstFlow=$('#firstFlow').val();
	var firstRewardFlow=$('#firstRewardFlow').val();
	var pars =  {"rechargeamt":rechargeamt,"rewardFlowFlag":rewardFlowFlag,"sumRechargeFlow":sumRechargeFlow,"sumRewardFlow":sumRewardFlow};
	$.ajax({ 
		type:"POST",
		data: pars,
		url: encodeURI("${pageContext.request.contextPath}/member/calculation.shtml"),
		dataType:"json", 
		async:false , 
...
$(function(){
	$("#recharge").click(function(){
		...
		var pars =  {"uid":uid,"rechargeamt":rechargeamt,"rewardamt":rewardamt,"showdetail":showdetail};
		if(flag != 'disabled'){
