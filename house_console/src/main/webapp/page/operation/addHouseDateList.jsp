					...
					<div class="tab-content default-tab">
						<form id="mainForm" action="" method="post" enctype="multipart/form-data">
							...
							<p>
									...
									<input type="text" id="date" name="date" class="text-input small-input" style="width: 100px" width="60px"  value="" />								
									</p>
								<p>
									<span class="public_title"><font color="red">*</font>&nbsp;增加天数：</span>
									<input type="text" id="day" name="day" class="text-input small-input" style="width: 100px" width="60px"  value="" />		
									<span class="Validform_checktip"></span>
								</p>
																
								 <p>
									<span class="public_title"><font color="red">*</font>&nbsp;会员价：</span>
									<input type="text"  id="memTotalAmt" name="memTotalAmt" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
								
								 <p>
									<span class="public_title"><font color="red">*</font>&nbsp;会员冻结：</span>
									<input type="text" value="" id="memFreezeAmt" name="memFreezeAmt" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
								
								 <p>
									<span class="public_title"><font color="red">*</font>&nbsp;普通价：</span>
									<input type="text"  id="totalAmt" name="totalAmt" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
								
								 <p>
									<span class="public_title"><font color="red">*</font>&nbsp;普通冻结：</span>
									<input type="text" value="" id="freezeAmt" name="freezeAmt" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
								
								<p>
									<span class="public_title"><font color="red">*</font>&nbsp;是否旺季：</span>
									<input type="radio" name="inSeason" value="true">是
									<input type="radio" name="inSeason" value="false">否
								</p>
			...
			.Validform(
					{
						...
						beforeSubmit : function(curform) {
								$("#mainForm").attr("action","${pageContext.request.contextPath}/house/addHouseDateList.shtml");
