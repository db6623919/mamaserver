					...
					<div class="tab-content default-tab">
						<form id="mainForm" action="" method="post" enctype="multipart/form-data">
							...
							<p>
									...
									<input type="text" id="cityName" name="cityName" class="text-input small-input" style="width: 100px" width="60px"  value="" />								
									</p>
								<p>
								...
								<p>
								 ...
								 <p>
									...
									<input type="file"  id="img" name="img" class="text-input small-input" style="width: 140px" />
									<span class="Validform_checktip"></span>
								</p>
			...
			.Validform(
					{
						...
						beforeSubmit : function(curform) {
								$("#mainForm").attr("action","${pageContext.request.contextPath}/city/addCity.shtml");
