...
public class HousesVo {
	...
	private int houseId;//房源编号
    private String houseName;//房源名称
    private String imgUrl;//房源图片URL
    private String price;//房源价格
    private String houseUnit;//房间单位
    private String description;//房源描述
    private String marketPrice;//市场价
    private String discountDescription;//折扣描述
    private String specialTag;//房源标签
    private int special_count;//20家相关
