...
import com.mmzb.house.app.web.dto.PageDto;
...
public class CommonUtil {
	...
	public static void printPageInfo(RestResponse restP,PageDto pagedto,Map<String, Object> map,HttpServletResponse resp) throws IOException{
		restP.setCode(Constant.CODE00000000);
		pagedto.setEnd(false);
		map.put("pager", pagedto);
		restP.setData(map);
...
//			classPath = CommonUtil.class.getClassLoader().getResource("/").toURI().getPath();
		...
		classPath = classPath.replace("\\", FinalUtil.FILE_SPLIT);
	...
	public static String compressImageUrl(String url)
	{
