...
//	 public static    JsonGenerator createMaptJSONObject(HttpServletResponse response,ActionResponse actionResponse,Map<String, Object> data) throws IOException{  
//		    response.setCharacterEncoding("utf-8");
//			response.setContentType("application/json;charset=UTF-8");
//		    objectMapper=new ObjectMapper();
//		    jsonGenerator=objectMapper.getFactory().createGenerator(response.getWriter());	
//			jsonGenerator.writeStartObject();
//			jsonGenerator.writeBooleanField("success", actionResponse.isSuccess());
//			if(actionResponse.isSuccess()){
//				jsonGenerator.writeStringField("message", actionResponse.toString()); 
//			}else{
//				jsonGenerator.writeObjectField("message", actionResponse.getMessage());  
//			} 
//			jsonGenerator.writeObjectField("code", actionResponse.getErrorCode()); 
