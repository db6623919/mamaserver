 ...
 */
package com.mmzb.house.app.common;

import java.io.Serializable;
import java.util.Map;

import com.mmzb.house.app.common.util.DepositInfoDto;
 ...
 *
 */
public class RestResponse<HttpServletRequest> implements Serializable {
    /**
     *
     */
    ...
    private Map<String,DepositInfoDto> projectMap;
	public Map<String, DepositInfoDto> getProjectMap() {
		return projectMap;
	}

	public void setProjectMap(Map<String, DepositInfoDto> projectMap) {
