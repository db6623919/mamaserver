package com.mmzb.house.ext.common;
...
public enum ResponseCodeEnum {
	    ...
	    MEMBER_FRIEND_CODE_GEN_FAIL("136","会员朋友码生成失败"),
	    MEMBER_FRIEND_CODE_NOT_EXIST("137","绑定的朋友码不存在"),
	    ...
	    PASSWORD_SET_FAIL("255","设置交易密码失败"),
	    PASSWORD_CHECK_FAIL("256","校验交易密码失败"),
	    PASSWORD_NOT_EXISTS("257","尚未设置交易密码"),
	    PASSWORD_TOO_SIMPLE("259","交易密码强度太弱"),
	    PASSWORD_TOO_SHORT("260","交易密码长度太小"),
	    PASSWORD_TOO_LONG("261","交易密码长度太大"),
	    PASSWORD_ILLEGAL_CHAR("262","交易密码包含非法字符"),
	    PASSWORD_LOCKED("264","交易密码被锁定"),
	    PASSWORD_EQUAL_LOGIN_PASSWORD("263","交易密码不能和登录密码相同"),
	    ...
	    LOGIN_PASSWORD_EQUAL_PAY("276","登录密码不能和交易密码相同"),
	    ...
	    VERIFY_FRIEND_NUM_FAIL("459","未找到对应的会员推荐信息"),
